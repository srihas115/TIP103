...
<details>
  <summary><strong>✨ AI Hint: Weighted Graphs</strong></summary>

*Key Skill: Use AI to explain code concepts*

This problem requires you to be familiar with weighted graphs. Learn more quickly by referencing the [Unit 10 Cheatsheet](https://courses.codepath.org/courses/tip103/unit/10#!cheatsheet)
